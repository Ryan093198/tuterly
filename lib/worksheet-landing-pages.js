...
export const WORKSHEET_LANDING_PAGES = [
  // ===== Year 7 =====
  {
    ...
    metaDescription:
      "Free Year 7 algebra worksheets aligned to the Victorian Curriculum. Worked solutions on variables, formulas and substitution. Generate one now.",
  },
  {
    ...
    metaDescription:
      "Free Year 7 linear equations worksheets aligned to the Victorian Curriculum. Practice \"solve for x\" questions with full worked solutions. Generate yours now.",
  },
  {
    ...
    metaDescription:
      "Free Year 7 fractions and decimals worksheets aligned to the Victorian Curriculum. Worked solutions covering multiplication, division and conversion.",
  },
  {
    ...
    metaDescription:
      "Free Year 7 percentages worksheets aligned to the Victorian Curriculum. Worked solutions covering discounts, GST and percent-of word problems.",
  },
  {
    ...
    metaDescription:
      "Free Year 7 integers worksheets aligned to the Victorian Curriculum. Practice questions on adding and subtracting positive and negative numbers, with worked solutions.",
  },
  {
    slug: "year-7-ratios",
    yearLevel: "Year 7",
    ...
    metaDescription:
      "Free Year 7 ratios worksheets aligned to the Victorian Curriculum. Worked solutions on simplifying, equivalent ratios and dividing quantities.",
  },
  {
    ...
    metaDescription:
      "Free Year 7 geometry worksheets aligned to the Victorian Curriculum. Worked solutions on classifying triangles, quadrilaterals and polygons.",
  },
  {
    slug: "year-7-angles",
    yearLevel: "Year 7",
    ...
    metaDescription:
      "Free Year 7 angles worksheets aligned to the Victorian Curriculum. Practice questions on parallel lines, transversals and angle sums with worked solutions.",
  },
  {
    ...
    metaDescription:
      "Free Year 7 area and perimeter worksheets aligned to the Victorian Curriculum. Worked solutions on rectangles, triangles and parallelograms.",
  },
  {
    slug: "year-7-volume",
    yearLevel: "Year 7",
    ...
    metaDescription:
      "Free Year 7 volume worksheets aligned to the Victorian Curriculum. Practice questions on volume of rectangular and triangular prisms, with worked solutions.",
  },
  {
    slug: "year-7-circles",
    yearLevel: "Year 7",
    ...
    metaDescription:
      "Free Year 7 circles worksheets aligned to the Victorian Curriculum. Worked solutions on pi, circumference, radius and diameter.",
  },
  {
    ...
    metaDescription:
      "Free Year 7 statistics worksheets aligned to the Victorian Curriculum. Worked solutions on mean, median, mode and range.",
  },
  {
    ...
    metaDescription:
      "Free Year 7 probability worksheets aligned to the Victorian Curriculum. Worked solutions on sample spaces, single-stage events and relative frequency.",
  },
  ...
  // ===== Year 8 =====
  {
    ...
    metaDescription:
      "Free Year 8 algebra worksheets aligned to the Victorian Curriculum. Worked solutions on expanding, factorising and simplifying linear expressions.",
  },
  {
    ...
    metaDescription:
      "Free Year 8 linear equations worksheets aligned to the Victorian Curriculum. Practice questions on graphing, solving and inequalities with worked solutions.",
  },
  {
    ...
    metaDescription:
      "Free Year 8 Pythagoras' theorem worksheets aligned to the Victorian Curriculum. Worked solutions on right-angled triangles.",
  },
  {
    slug: "year-8-circles",
    yearLevel: "Year 8",
    ...
    metaDescription:
      "Free Year 8 circles worksheets aligned to the Victorian Curriculum. Worked solutions on circumference, area, and composite circle shapes.",
  },
  {
    ...
    metaDescription:
      "Free Year 8 area and perimeter worksheets aligned to the Victorian Curriculum. Practice questions on composite and irregular shapes with worked solutions.",
  },
  {
    slug: "year-8-volume",
    yearLevel: "Year 8",
    ...
    metaDescription:
      "Free Year 8 volume worksheets aligned to the Victorian Curriculum. Worked solutions on right prisms and capacity.",
  },
  {
    ...
    metaDescription:
      "Free Year 8 percentages worksheets aligned to the Victorian Curriculum. Worked solutions on increases, decreases, GST and percentage error.",
  },
  {
    slug: "year-8-rates",
    yearLevel: "Year 8",
    ...
    metaDescription:
      "Free Year 8 rates worksheets aligned to the Victorian Curriculum. Practice questions on speed, density, unit pricing with worked solutions.",
  },
  {
    ...
    metaDescription:
      "Free Year 8 exponent law worksheets aligned to the Victorian Curriculum. Worked solutions on multiplying, dividing and power-of-power.",
  },
  {
    ...
    metaDescription:
      "Free Year 8 congruence and similarity worksheets aligned to the Victorian Curriculum. Worked solutions on triangle conditions and ratios.",
  },
  {
    ...
    metaDescription:
      "Free Year 8 statistics worksheets aligned to the Victorian Curriculum. Worked solutions on population, sample and sampling methods.",
  },
  {
    ...
    metaDescription:
      "Free Year 8 probability worksheets aligned to the Victorian Curriculum. Worked solutions on tree diagrams, Venn diagrams and two-way tables.",
  },
  {
    ...
    metaDescription:
      "Free Year 8 time worksheets aligned to the Victorian Curriculum. Practice questions on duration, 24-hour time and time-zone problems with worked solutions.",
  },
  ...
  // ===== Year 9 =====
  {
    ...
    metaDescription:
      "Free Year 9 quadratics worksheets aligned to the Victorian Curriculum. Worked solutions on graphing parabolas and null factor law.",
  },
  {
    slug: "year-9-algebra",
    yearLevel: "Year 9",
    ...
    metaDescription:
      "Free Year 9 algebra worksheets aligned to the Victorian Curriculum. Practice questions on binomial expansion, factorising monic quadratics and simplifying.",
  },
  {
    ...
    metaDescription:
      "Free Year 9 linear equations worksheets aligned to the Victorian Curriculum. Practice questions on sketching, solving and intersections with worked solutions.",
  },
  {
    ...
    metaDescription:
      "Free Year 9 trigonometry worksheets aligned to the Victorian Curriculum. SOHCAHTOA questions with worked solutions on right-angled triangles.",
  },
  {
    ...
    metaDescription:
      "Free Year 9 Pythagoras worksheets aligned to the Victorian Curriculum. Applied questions combining Pythagoras with similarity and ratio.",
  },
  {
    ...
    metaDescription:
      "Free Year 9 surface area and volume worksheets aligned to the Victorian Curriculum. Practice questions on prisms, cylinders and composite solids.",
  },
  {
    ...
    metaDescription:
      "Free Year 9 coordinate geometry worksheets aligned to the Victorian Curriculum. Practice questions on gradient, midpoint and distance with worked solutions.",
  },
  {
    ...
    metaDescription:
      "Free Year 9 exponent law worksheets aligned to the Victorian Curriculum. Worked solutions on index law application to variables.",
  },
  {
    ...
    metaDescription:
      "Free Year 9 scientific notation worksheets aligned to the Victorian Curriculum. Practice questions on standard form conversions and calculations.",
  },
  {
    ...
    metaDescription:
      "Free Year 9 simple interest worksheets aligned to the Victorian Curriculum. Financial maths questions with worked solutions.",
  },
  {
    ...
    metaDescription:
      "Free Year 9 statistics worksheets aligned to the Victorian Curriculum. Practice questions on data displays, distributions and sampling.",
  },
  {
    ...
    metaDescription:
      "Free Year 9 probability worksheets aligned to the Victorian Curriculum. Practice questions on two-step events, replacement and relative frequency.",
  },
  ...
  // ===== Year 10 =====
  {
    ...
    metaDescription:
      "Free Year 10 simultaneous equations worksheets aligned to the Victorian Curriculum. Worked solutions on substitution, elimination and graphical.",
  },
  {
    ...
    metaDescription:
      "Free Year 10 quadratic equations worksheets aligned to the Victorian Curriculum. Worked solutions on null factor law and factorising.",
  },
  {
    ...
    metaDescription:
      "Free Year 10 quadratic factorising worksheets aligned to the Victorian Curriculum. Practice questions on expanding and factorising with worked solutions.",
  },
  {
    ...
    metaDescription:
      "Free Year 10 trigonometry worksheets aligned to the Victorian Curriculum. Applied questions on Pythagoras, SOHCAHTOA, bearings and elevation.",
  },
  {
    ...
    metaDescription:
      "Free Year 10 surface area and volume worksheets aligned to the Victorian Curriculum. Composite-object questions with worked solutions.",
  },
  {
    ...
    metaDescription:
      "Free Year 10 linear equations worksheets aligned to the Victorian Curriculum. Multi-step questions with worked solutions.",
  },
  {
    ...
    metaDescription:
      "Free Year 10 linear inequalities worksheets aligned to the Victorian Curriculum. Worked solutions and number-line representations.",
  },
  {
    ...
    metaDescription:
      "Free Year 10 algebraic fractions worksheets aligned to the Victorian Curriculum. Practice questions on the four operations with worked solutions.",
  },
  {
    ...
    metaDescription:
      "Free Year 10 exponential equations worksheets aligned to the Victorian Curriculum. Practice questions on same-base solving with worked solutions.",
  },
  {
    ...
    metaDescription:
      "Free Year 10 coordinate geometry worksheets aligned to the Victorian Curriculum. Practice questions on parallel, perpendicular and equation-of-line problems.",
  },
  {
    ...
    metaDescription:
      "Free Year 10 compound interest worksheets aligned to the Victorian Curriculum. Practice questions on growth, decay and compound interest with worked solutions.",
  },
  {
    ...
    metaDescription:
      "Free Year 10 statistics worksheets aligned to the Victorian Curriculum. Practice questions on quartiles, IQR and boxplots with worked solutions.",
  },
  {
    ...
    metaDescription:
      "Free Year 10 probability worksheets aligned to the Victorian Curriculum. Practice questions on conditional probability and independence with worked solutions.",
  },
];
