...
export const MATHS_OVERVIEWS = {
  "Foundation": [
    ...
    {
      keywords: ["creating and continuing patterns"],
    ...
    {
      keywords: ["multiplicative thinking"],
  ...
  "Year 1": [
    ...
    {
      keywords: ["creating and continuing number patterns"],
    ...
    {
      keywords: ["informal measurement"],
      name: "Informal measurement",
      goals: [
        "Knowing how to make reasonable estimates of the length, mass and capacity of objects",
        "Understanding and using the vocabulary to describe length, mass and capacity                                                  Number      Measurem",
  ...
  "Year 2": [
    ...
    {
      keywords: ["directions, turns and pathways"],
    ...
    {
      keywords: ["introducing fractions"],
    ...
    {
      keywords: ["multiplicative thinking measurement: length, mass and capacity"],
      name: "Multiplicative thinking Measurement: length, mass and capacity",
      goals: [
        "Demonstrating proficiency of multiplication facts for 2s",
        "Using arrays to represent multiplication and division                                                  Number",
    ...
    {
      keywords: ["algebraic patterns continued"],
      name: "Algebraic patterns continued",
      goals: [
  ...
  "Year 3": [
    {
      keywords: ["place value structures"],
    ...
    {
      keywords: ["properties of shapes and objects"],
      ...
      goals: [
        ...
        "Evaluating why certain objects are more suitable for specific uses                                                              Space        Statis",
    ...
    {
      keywords: ["data and statistics measurement"],
      name: "Data and statistics Measurement",
      goals: [
        "Describing possible outcomes and events as ‘likely’ or ‘unlikely’ and identifying some events as ‘certain’ or ‘impossible’,",
        "Knowing how to conduct chance experiments to record data                                                                                     Probab",
  ...
  "Year 4": [
    {
      keywords: ["extend place value and additive thinking"],
    ...
    {
      keywords: ["understanding fractions"],
    ...
    {
      keywords: ["transformation and location"],
  ...
  "Year 5": [
    ...
    },
    {
      ...
      goals: [
        ...
        "Understanding that perimeter and area are not the same                                                                       Number     Measuremen",
    ...
    {
      keywords: ["probability analysis"],
      name: "Probability analysis",
      goals: [
        "Creating chance experiment outcome statements including 'equally likely' and 'not equally likely'                                      Probabili",
    ...
    {
      keywords: ["static angles time and statistics"],
      name: "Static angles Time and statistics",
      goals: [
        "Being able to estimate angles",
        "Creating angles",
        "Measuring angles",
        "Comparing and convert 12- and 24-hour time systems",
        "Interpreting line graphs representing change over time                                                                                        VC",
        "Planning and conducting statistical investigation",
      ],
      codes: ["VC2M5M04", "VC2M5N08", "VC2M5ST02", "VC2M5ST03", "VC2M5M03"],
    },
    {
      keywords: ["transformations, grid references and grid coordinates"],
      ...
      goals: [
        ...
        "Recognising perform and describing translations, reflections and rotations of shapes                                                          VC",
  ...
  "Year 6": [
    ...
    {
      keywords: ["measurement investigations"],
    ...
    {
      keywords: ["properties of rectangles"],
      name: "Properties of rectangles",
      goals: [
        "Deriving and applying rectangle formulas",
        "Solving comparative and constant area and perimeter problems                                                                            Measureme",
    ...
    {
      keywords: ["conceptualising fractions"],
    ...
    {
      keywords: ["chance and game design"],
  ...
  "Year 7": [
    {
      keywords: ["directed number"],
      name: "Directed number",
      goals: [
        "Comparing and ordering integers                                                                                                                Numb",
    ...
    },
    {
      ...
      goals: [
        "Developing a conceptual understanding of the five constructs of fractions                                                                      Numb",
    ...
    {
      keywords: ["operating with numbers"],
    ...
    {
      keywords: ["proportional reasoning"],
    ...
    {
      keywords: ["exploring and investigating data"],
  ...
  "Year 8": [
    {
      keywords: ["comparing proportional quantities"],
      name: "Comparing proportional quantities",
      goals: [
        "Solving complex percentage problems involving compound interest, compound growth and percentage error using sophisticated                        N",
        "Utilising mathematical modelling to analyse financial scenarios, including profit margins, discounts and revenue optimisation strategies       Mea",
        "Investigating rates in multivariate contexts                                                                                                    VC",
        "Comparing and analysing proportional relationships between multiple variables                                                                   VC",
      ],
      codes: ["VC2M8N05", "VC2M8N06", "VC2M8M05", "VC2M8M07"],
    },
    {
      keywords: ["exponentials and irrational numbers"],
      ...
      goals: [
        ...
        "Exploring the basics of exponential functions and index laws and understanding their fundamental properties and relationships                    N",
        "Establishing and applying exponent laws with positive integer exponents, developing skills in simplifying expressions and solving               VC",
    ...
    },
    {
      ...
      goals: [
        "Introducing Pythagoras’ theorem and its significance in finding the missing length in a right‑angled triangle                                  Numbe",
    ...
    },
    {
      ...
      goals: [
        "Exploring the conditions for similarity of shapes, including angle–angle (AA) and side–side–side (SSS), and understanding their              Measure",
    ...
    {
      keywords: ["measurement using polygons and circles"],
      ...
      goals: [
        ...
        "Calculating the area of polygons and composite shapes and occasionally using Pythagoras’ theorem while employing both numerical and          Measure",
    ...
    {
      keywords: ["analysing statistics and probability in context"],
      ...
      goals: [
        ...
        "Determining all possible outcome combinations for two events using two‑way tables, tree diagrams and Venn diagrams and applying                  P",
        "Conducting repeated chance experiments and simulations using digital tools to determine probabilities for compound events and                    V",
      ],
    ...
    },
    {
      ...
      goals: [
        ...
        "Using mathematical modelling to predict and analyse profit and loss scenarios in various business contexts and applying linear functions         V",
      ],
  ...
  "Year 9": [
    ...
    {
      keywords: ["probability and statistics in game design"],
      ...
      goals: [
        ...
        "Analysing and comparing experimental and theoretical probabilities to evaluate fairness and make predictions in games and               Proba",
  ...
  "Year 10": [
    ...
    {
      keywords: ["linear functions part b", "sketching linear", "linear inequalities"],
    ...
    {
      keywords: ["quadratic fundamentals", "quadratic", "perfect square", "difference of squares", "factorisation", "quadratic formula"],
    ...
    {
      keywords: ["quadratic rules and graphs", "quadratic graphs", "parabola"],
    ...
    {
      keywords: ["functions and relations", "function notation", "domain", "polynomials", "remainder theorem", "factor theorem"],
    ...
    {
      keywords: ["building with geometry", "pythagoras", "surface area", "volume", "composite objects"],
    ...
    {
      keywords: ["discoverable networks", "networks", "connected network"],
    ...
    {
      keywords: ["probability and decision making", "conditional probability", "two-step", "three-step chance", "independence in probability"],
    ...
    {
      keywords: ["investigating statistics", "quartiles", "interquartile range", "boxplot", "two-way table", "bivariate data"],
    ...
    {
      keywords: ["applying algorithms", "pseudocode", "simulations"],
    ...
    {
      keywords: ["working with exponentials", "exponentials and logarithms", "logarithm laws", "logarithmic equations"],
