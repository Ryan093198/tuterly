import { commissionRate } from "@/lib/billing-config";
...
//   - deduct_one_credit is an atomic DB decrement that can't go negative;
...
export async function settleSessionBilling(admin, { sessionId, reportId = null }) {
  ...
  // Atomic decrement, hard-stop at zero.
  ...
  if (newRemaining === 1) creditWarning = "low_balance";
  else if (newRemaining === 0) creditWarning = "out_of_credits";
