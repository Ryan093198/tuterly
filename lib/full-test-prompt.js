...
export const SYSTEM_INSTRUCTIONS_FULL_TEST_ANSWERS = `You are an experienced tutor writing the ANSWER KEY for a practice test that has already been written. You will be given the exact 25 questions. Solve each one and produce a clean answer key that matches the question numbers exactly.
...
- Keep each entry concise: an "Answer:" line plus 1-3 lines of working.
- The "Answer:" line MUST agree numerically with the working below it. If they disagree you have made an error - redo privately and emit one consistent answer.
- Do NOT restate the full question. Do NOT use <details>/<summary>.
${FORMATTING_RULES}
${NO_LEAK_RULES}
